...
const Card = (props) => {
    ...
    const {productItem, cart, wishList, listsHandler} = props; //получаем пропсы из APP.jsx
    const {cartHandler, wishListHandler} = props; // получаем пропсы из корзины или избранного.
    let prodIsInCart;
    ...
    //далее: если прилетает listsHandler, значит Card вызван из App и рендерим нужный для App блок кнопок:
